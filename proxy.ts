...
// optimistic cookie-presence check; the API routes that actually save an attempt
// still validate the session server-side. (Next's `proxy` runs on the Node runtime.)
